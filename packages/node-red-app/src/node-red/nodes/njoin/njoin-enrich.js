...
module.exports = function (RED) {
    ...
    function EnrichNode(n) {
        ...
        if (RED.settings.httpNodeRoot !== false) {
            n.method = "post";
            n.url = (n.name)?"/_enrich/"+n.name.replace(/ /g, "-"):null;
            log.debug("[Message-in] Binding with "+n.url);
            if (!n.url) {
            ...
            this.callback = function(req,res) {
                log.debug("Request accepted for ",node.name," with msg ",req.body);
    ...
    RED.nodes.registerType("enrich",EnrichNode);
